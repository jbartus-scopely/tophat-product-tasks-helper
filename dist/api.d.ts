...
export declare function filterTasks(backlog: BacklogData, category: string, group?: string, limit?: number): TasksResponse;
...
export declare function apiFindDuplicates(backlog: BacklogData, cache?: boolean, model?: string): Promise<{
    text: string;
} | null>;
