...
function csvFilePath(opt: boolean | string | undefined): string | undefined {
...
function loadBacklog(filePath?: string): BacklogData {
...
function getGroups(backlog: BacklogData): string[] {
...
async function pickGroup(backlog: BacklogData): Promise<string | undefined> {
...
async function runInteractive(backlog: BacklogData): Promise<void> {
  printBanner(backlog);
